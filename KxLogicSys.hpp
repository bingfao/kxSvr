...
private:
	...
	void AppCtrlSvrLogSocketDataCallBack(std::shared_ptr<KxDevSession>, const KxMsgPacket_Basic &msgPacket);
	void AppCtrlDevLogDataCallBack(std::shared_ptr<KxDevSession>, const KxMsgPacket_Basic &msgPacket);
